...
Score piece_bonus[][8][4] = {
	...
	{ // Rook
	 { S(  5,  2), S(  3, 6), S(  3,  7), S( 2, 7) },
	 { S( 15,  0), S( 17,-7), S( 20,  1), S(21, 0) },
	 { S( 13,  0), S(  7,-4), S(  3,  2), S(-1,-2) },
	...
	{ // Queen
	 ...
	 { S(-3,-39), S( 6,-18), S( 4, -9), S( 7,  3) },
	 { S( 5,-23), S( 6, -3), S( 9, 13), S( 8, 24) },
	 { S( 2,-29), S( 8, -6), S( 7,  9), S( 5, 21) },
	 { S(-3,-38), S( 9,-18), S( 6,-12), S( 8,  1) },
	 { S(-5,-50), S( 6,-27), S(12,-24), S( 8, -8) },
	 { S(-2,-75), S(-2,-52), S( 1,-43), S( 5,-36) }
	},
	{ // King
...
{ // Pawn (asymmetric distribution)
	 { },
	 { S(  7, 25), S(  7, 21), S( -3, 22), S( 13, 21), S(  5, 25), S( -6, 25), S( 10, 20), S(  8, 20) },
	 { S(  5, 20), S(  2, 20), S( -7, 21), S( 22, 28), S( 13, 30), S( -5, 14), S(-15, 15), S(  3, 13) },
	 { S( 10, 12), S(  0, 12), S(  3, 13), S( 25, 12), S( 25, 12), S(  5,  6), S(-30, 13), S(  0,  9) },
	 { S( -8,  6), S(-18,  5), S( 18,  8), S( 40,  9), S( 40,  7), S( 13,  4), S(-35, -5), S( -9,  4) },
	 { S( -9,-10), S(  7,-10), S( 21, -2), S( 25,  4), S( 25,  4), S(  4,  2), S( 13, -6), S( 20, -4) },
	 { S(  3,-10), S(  3,-16), S( 10,-10), S( 19,  0), S( 16, -3), S( 19, -5), S( 32, -5), S( 25,-19) },
	 {}
};
#undef S
