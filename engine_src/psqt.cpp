...
Score piece_bonus[][8][4] = {
  ...
  { // Knight
   ...
   { S( -67, -64), S(-21,-45), S(  6,-37), S( 43, 16) },
...
{ // Pawn (asymmetric distribution)
   ...
   { S( 10,  9), S(  0,  4), S(-13,  3), S(  1,-12), S( 11,-12), S(  5, -6), S(-13, 13), S(  0,  8) },
   { S( -8,  6), S(-23, -2), S(  6, -8), S( 40, -4), S( 40,-13), S( 23,-12), S(  4,-10), S(-12, -9) },
   { S( -9,-10), S(-15,-10), S( 21,-10), S( 25,  4), S( 25,  4), S( 12,  3), S(  5, -6), S(  5, -4) },
   { S(  3,-10), S(  3, -6), S( 10, 10), S( 19,  0), S( 16, 14), S( 19,  7), S(  7, -5), S( 15,-19) },
   {}
};
#undef S
