	...
	if (to_move) {
		...
		for (const pii& p : piecelists[WP + 6]) {
			if (board[p.first - 1][p.second] == 0) {
				if (p.first != 1) {
					if (!captures) {
						res.push_back((p.first << 3) + p.second + ((((p.first - 1) << 3) + p.second) << 6) +
									  (WP << 12));
				...
				if (board[p.first - 1][p.second - 1] < 0) {
					if (p.first == 1) {
						res.push_back((p.first << 3) + p.second + ((((p.first - 1) << 3) + p.second - 1) << 6) +
									  (abs(board[p.first][p.second]) << 12) +
									  (abs(board[p.first - 1][p.second - 1]) << 15) + 3670016);
						res.push_back((p.first << 3) + p.second + ((((p.first - 1) << 3) + p.second - 1) << 6) +
									  (abs(board[p.first][p.second]) << 12) +
									  (abs(board[p.first - 1][p.second - 1]) << 15) + 524288);
						res.push_back((p.first << 3) + p.second + ((((p.first - 1) << 3) + p.second - 1) << 6) +
									  (abs(board[p.first][p.second]) << 12) +
									  (abs(board[p.first - 1][p.second - 1]) << 15) + 1572864);
						res.push_back((p.first << 3) + p.second + ((((p.first - 1) << 3) + p.second - 1) << 6) +
									  (abs(board[p.first][p.second]) << 12) +
									  (abs(board[p.first - 1][p.second - 1]) << 15) + 2621440);
					} else {
						res.push_back((p.first << 3) + p.second + ((((p.first - 1) << 3) + p.second - 1) << 6) +
									  (abs(board[p.first][p.second]) << 12) +
									  (abs(board[p.first - 1][p.second - 1]) << 15));
					}
		...
		for (const pii& p : piecelists[WN + 6]) {
			for (int i = 0; i < 8; i++) {
				...
				if (!out_of_bounds(row_final, col_final) && board[row_final][col_final] <= 0 &&
					(!captures || board[row_final][col_final] != 0)) {
